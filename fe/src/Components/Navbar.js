  ...
  return (
    <>
        <nav className='contaner flex justify-between leading-5 w-100%'  >
            <div className="logo">
                <Link to='/'><img className=' cursor-pointer m-2 p-4 absolute left-0 top-0 w-20' src={logo} alt="Logo" /></Link>
            </div>
            ...
            <div id='navbar' className="socialMedia justify-between text-white text-md w-36"  >
                <a href="https://www.instagram.com/metaverse_iiitbh/"><BsInstagram className='cursor-pointer' id='socialMedia' /></a>
                <a href="https://www.linkedin.com/company/learnmetaverse/"><BsLinkedin className='cursor-pointer' id='socialMedia' /></a>
                <a href="https://github.com/metaiiitverse"><BsGithub className='cursor-pointer' id='socialMedia' /></a>
            </div>
